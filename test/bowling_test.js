...
context('Bowling score', function() {
   ...
   context('Score without bonus', function() {
   ...
   context('Is spare', function() {
      ...
      it('should obtain a score of 23 with a spare on second frame and two other throws', function() {
         // given
